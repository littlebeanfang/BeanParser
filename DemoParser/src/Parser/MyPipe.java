...
public class MyPipe extends DependencyPipe {
    ...
    public Object[] extractLabeledFeatures(DependencyInstance instance, int child, int parent, Parameters param) {
        /**
...
//            }
    ...
    private void addHMGfeatures(DependencyInstance instance, int parentindex, int childindex, ParseAgenda pa, FeatureVector fv) {
        //It still needs further discussion how to add this structure : the GHM or GMH or MGH or MHG and so on.
...
//        System.out.println(rsb);
    ...
    public FeatureVector[] extractFeatureVector(DependencyInstance instance) {
        ...
        ParseAgenda pa = new ParseAgenda(this.typeAlphabet);
        for (int order_index = 1; order_index < instance.length(); order_index++) {
            ...
            if (options.labeled) {
                addMyTrainLabeledFeatures(instance, parse_index, parse_head, instance.deprels[parse_index], labelfv);
            }
    ...
    public void addMyTrainLabeledFeatures(DependencyInstance instance, int child, int parent, String relation, FeatureVector fv) {
        /**
        ...
        //FeatureVector fvtemp=new FeatureVector();
        boolean attR = child < parent ? false : true;
        this.addLabeledFeatures(instance, child, relation, attR, true, fv);
        this.addLabeledFeatures(instance, parent, relation, attR, false, fv);
    }
    ...
    public final int createMyAlphabet(String file) throws IOException {
        ...
        withLabel = reader.startReading(System.getenv("CODEDATA") + File.separator + file);
        ...
        while (instance != null) {
            ...
            instance.setFeatureVector(extractFeatureVector(instance)[0]);
