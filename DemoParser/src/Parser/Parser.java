...
public class Parser {
    ...
    public void loadModel(String file) throws ClassNotFoundException, IOException {
        ...
        System.out.println("Bean model loaded!");
        in.close();
        pipe.closeAlphabets();
    }
    ...
    public String onlineParse(String ConllSentence) throws IOException{
        CONLLReader reader = new CONLLReader();
        DependencyInstance di = reader.SentenceToInstance(ConllSentence);
        decoder.DecodeInstance(di, di.orders);
        CONLLWriter writer = new CONLLWriter(true);
        return writer.toSanfordFormat(di);
    }
