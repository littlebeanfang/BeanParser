...
public class DependencyPipe {
    ...
    public String[] types;
    public boolean withLabel = false;
    ...
    public DependencyPipe(ParserOptions options) throws IOException {
        ...
        depReader = DependencyReader.createDependencyReader("CONLL");
    }

    public void initInputFile(String file) throws IOException {
        withLabel = depReader.startReading(file);
    }

    public void initOutputFile(String file) throws IOException {
        depWriter =
                DependencyWriter.createDependencyWriter("CONLL", withLabel);
